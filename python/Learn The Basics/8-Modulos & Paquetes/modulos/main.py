...
# import calculos
import calculos as calc	# cambia el nombre del modulo
	...
	while True:
		try:
			...
			if opcion == 0:
				...
				# result = calculos.suma(A, B)
				result = calc.suma(A, B)
				print(f"{A} + {B} = {result}")
			elif opcion == 2:   # A - B
				# result = calculos.resta(A, B)
				result = calc.resta(A, B)
				print(f"{A} - {B} = {result}")
			elif opcion == 3:   # A * B
				# result = calculos.multiplicacion(A, B)
				result = calc.multiplicacion(A, B)
				print(f"{A} * {B} = {result}")
			elif opcion == 4:   # A / B
				# result = calculos.division(A, B)
				result = calc.division(A, B)
				print(f"{A} / {B} = {result}")
			elif opcion == 5:   # A ^ B
				# result = calculos.potencia(A, B)
